(function() {
	...
	$DemoMix.execute = function(parent) {
		...
		$t5.cg.input.name = 'Name';
		$t5.cg.label.set_text('Nombre');
		form.append($t5);
		var $t6 = Cayita.UI.TextField();
		$t6.cg.input.name = 'First';
		$t6.cg.label.set_text('Apellido');
		form.append($t6);
		var $t7 = Cayita.UI.IntField();
		$t7.cg.input.name = 'Age';
		$t7.cg.label.set_text('Edad');
		form.append($t7);
		var $t8 = Cayita.UI.NumericField();
		$t8.cg.input.name = 'Average';
		$t8.cg.label.set_text('Promedio');
		form.append($t8);
		var lang = Cayita.UI.RadioGroup(String)();
		lang.cg.set_name('FavouriteLanguage');
		lang.set_text('Programming Language');
		lang.cg.addValue('Java', 'Java 6', false);
		lang.cg.addValue('Basic', 'Basic', false);
		lang.cg.addValue('CSharp', 'C #', false);
		lang.cg.addValue('Fortran', 'FORTRAN', false);
		form.append(lang);
		var $t9 = Cayita.UI.CheckField();
		$t9.set_text('Active?');
		$t9.cg.input.name = 'Active';
		form.append($t9);
		var opt1 = Cayita.UI.CheckGroup(ss.Int32)();
		opt1.cg.set_name('Ids');
		opt1.cg.addValue(1, 'Opcion 1', false);
		opt1.cg.addValue(2, 'Opcion 2', false);
		opt1.cg.addValue(3, 'Opcion 3', false);
		opt1.cg.addValue(4, 'Opcion 4', false);
		opt1.cg.addValue(5, 'Opcion 5', false);
		opt1.cg.addValue(6, 'Opcion 6', false);
		form.append(opt1);
		...
		nb.nav.addValue('2', 'Toggle Inverse', function(e13) {
			nb.nav.inverse(!nb.nav.isInverse());
		}, false, null);
		...
		nf.cg.input.set_value(12);
		work.append(nf);
		var cbf = Cayita.UI.CheckField('MyName', 'Accept ?');
		work.append(cbf);
		var mf = Cayita.UI.TextField();
		mf.cg.prependAddon(Cayita.UI.Atom('i', null, 'icon-envelope'));
		var $t13 = Cayita.UI.Button();
		$t13.set_text('Hello world');
		mf.cg.appendAddon($t13);
		work.append(mf);
		var cbg = Cayita.UI.CheckGroup(ss.Int32)();
		var $t14 = Cayita.UI.CheckOption(ss.Int32)();
		$t14.go.input.set_value(1);
		$t14.set_text('Opcion 1');
		cbg.cg.addOption($t14);
		var $t15 = Cayita.UI.CheckOption(ss.Int32)();
		$t15.go.input.set_value(2);
		$t15.set_text('Opcion 2');
		cbg.cg.addOption($t15);
		cbg.cg.addOption(Cayita.UI.CheckOption(ss.Int32)(3, 'Opcion 2', true));
		cbg.cg.addValue(4, 'Opcion4', false);
		cbg.cg.addValue(5, null, true);
		cbg.cg.addValue(6, null, false);
		work.append(cbg);
		var rdg = Cayita.UI.RadioGroup(ss.Int32)();
		rdg.cg.set_name('MyRadio');
		var $t16 = Cayita.UI.RadioOption(ss.Int32)();
		$t16.go.input.set_value(1);
		$t16.set_text('Opcion 1');
		rdg.cg.addOption($t16);
		var $t17 = Cayita.UI.RadioOption(ss.Int32)();
		$t17.go.input.set_value(2);
		$t17.set_text('Opcion 2');
		rdg.cg.addOption($t17);
		rdg.cg.addOption(Cayita.UI.RadioOption(ss.Int32)(3, 'Opcion 3', false));
		rdg.cg.addValue(4, 'Radio 4', false);
		rdg.cg.addValue(5, null, false);
		rdg.cg.addValue(6, null, true);
		work.append(rdg);
		var cbg1 = Cayita.UI.CheckGroup(ss.Int32)();
		var $t18 = Cayita.UI.CheckOption(ss.Int32)();
		$t18.go.input.set_value(1);
		$t18.set_text('Opcion 1');
		cbg1.cg.addOption($t18);
		var $t19 = Cayita.UI.CheckOption(ss.Int32)();
		$t19.go.input.set_value(2);
		$t19.set_text('Opcion 2');
		cbg1.cg.addOption($t19);
		cbg1.cg.addOption(Cayita.UI.CheckOption(ss.Int32)(3, 'Opcion 2', true));
		cbg1.cg.addValue(4, 'Opcion4', false);
		cbg1.cg.addValue(5, null, true);
		cbg1.cg.addValue(6, null, false);
		cbg1.cg.add_checked(function(e16) {
			var g = e16.currentTarget;
			cbg.cg.checkValue(g.go.input.get_value(), g.go.input.checked);
			rdg.cg.checkValue(g.go.input.get_value(), g.go.input.checked);
		});
		work.append(cbg1);
		...
		cbg2.cg.loadList(options, false);
		work.append(cbg2);
		...
		cg1.cg.label.set_text('Soy un Control group');
		cg1.cg.label.style.cssText = 'color:red;';
		cg1.style.backgroundColor = 'blue';
		cg1.cg.label.set_for('ElIdDeAlgunInput');
		work.append(cg1);
		console.log(cg1);
		console.log(cg1.cg.label);
		console.log(cg1.cg.controls);
	...
	ss.registerClass(global, 'Cayita.Demo.MyCountrySearchBoxConfig', $Cayita_Demo_MyCountrySearchBoxConfig, Cayita.SearchBoxConfig);
