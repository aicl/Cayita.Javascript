(function() {
	...
	$DemoTables.execute = function(parent) {
		...
		$($DemoTables.$uForm.element$1()).on('change', 'input', function(e) {
			$DemoTables.$uForm.getSaveButton().disabled = !cayita.fn.hasChanged($DemoTables.$uForm.element$1());
		});
		$DemoTables.$uGrid.add_rowSelected(function(g, sr) {
	...
	$DemoTables.$getLevelOptions = function() {
		var $t1 = Cayita.UI.GroupItem.$ctor();
		$t1.text = 'A';
		$t1.value = 'A';
		var $t2 = Cayita.UI.GroupItem.$ctor();
		$t2.text = 'B';
		$t2.value = 'B';
		var $t3 = Cayita.UI.GroupItem.$ctor();
		$t3.text = 'C';
		$t3.value = 'C';
	...
	$DemoTables.$showCodeCrud = function(parent) {
		(new Cayita.UI.Div.$ctor2(null, function(div) {
			...
			Extensions.text$1(document.createElement('h3'), 'User.cs').appendTo(div);
			...
			Extensions.text$1(document.createElement('h3'), 'UserGrid.cs').appendTo(div);
	...
	var $UserForm = function(parent, levelOptions) {
		...
		new Cayita.UI.Div.$ctor2(this.$f, function(tb) {
			tb.className = 'nav';
		...
		new Cayita.UI.RadioGroup.$ctor3(this.$f, 'Level', 'Level', levelOptions, true);
		new Cayita.UI.CheckboxField.$ctor4(this.$f, function(l6, e7) {
			Extensions.text$1(l6, 'Is Active?');
			e7.name = 'IsActive';
		});
