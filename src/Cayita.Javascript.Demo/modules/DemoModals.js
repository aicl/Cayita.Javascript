(function() {
	...
	$DemoModals.execute = function(parent) {
		...
		(new Cayita.UI.Div.$ctor2(null, function(div) {
			...
			Extensions.append(div, new Cayita.UI.Button.$ctor2(div, function(b) {
		...
		(new Cayita.UI.Div.$ctor2(null, function(div1) {
			...
			Extensions.append(div1, new Cayita.UI.Button.$ctor2(div1, function(b1) {
		...
		(new Cayita.UI.Div.$ctor2(null, function(div2) {
			...
			Extensions.append(div2, new Cayita.UI.Button.$ctor2(div2, function(b2) {
		...
		(new Cayita.UI.Div.$ctor2(null, function(div3) {
			...
			Extensions.append(div3, new Cayita.UI.Button.$ctor2(div3, function(b3) {
		...
		(new Cayita.UI.Div.$ctor2(null, function(div4) {
			...
			Extensions.append(div4, new Cayita.UI.Button.$ctor2(div4, function(b4) {
		...
		(new Cayita.UI.Div.$ctor2(null, function(div5) {
			...
			Extensions.append(div5, new Cayita.UI.Button.$ctor2(div5, function(b5) {
		...
		(new Cayita.UI.Div.$ctor2(null, function(div6) {
			...
			Extensions.append(div6, new Cayita.UI.Button.$ctor2(div6, function(b6) {
		...
		(new Cayita.UI.Div.$ctor2(null, function(div7) {
			...
			Extensions.append(div7, new Cayita.UI.Button.$ctor2(div7, function(b7) {
