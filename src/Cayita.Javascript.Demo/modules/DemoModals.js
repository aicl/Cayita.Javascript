(function() {
	...
	$DemoModals.execute = function(parent) {
		...
		(new Cayita.UI.Div.$ctor2(null, function(div3) {
			...
			$(div3).append((new Cayita.UI.Button.$ctor2(div3, function(b3) {
				...
				$(b3).on('click', function(evt3) {
					var d = new Cayita.UI.Div.$ctor2(null, function(dd) {
						...
						new Cayita.UI.TextArea.$ctor2(dd, function(area) {
			...
			$(div3).append('<div class="dp-highlighter"><div class="bar"><div class="tools"><a href="#" onclick="dp.sh.Toolbar.Command(\'ViewSource\',this);return false;">view plain</a><a href="#" onclick="dp.sh.Toolbar.Command(\'CopyToClipboard\',this);return false;">copy to clipboard</a><a href="#" onclick="dp.sh.Toolbar.Command(\'PrintSource\',this);return false;">print</a><a href="#" onclick="dp.sh.Toolbar.Command(\'About\',this);return false;">?</a></div></div><ol start="1" class="dp-c"><li class="alt"><span><span>var&nbsp;d&nbsp;=&nbsp;</span><span class="keyword">new</span><span>&nbsp;Div(</span><span class="keyword">null</span><span>,&nbsp;dd=&gt;{&nbsp;&nbsp;</span></span></li><li class=""><span>&nbsp;&nbsp;&nbsp;&nbsp;dd.ClassName=<span class="string">"span3"</span><span>;&nbsp;&nbsp;</span></span></li><li class="alt"><span>&nbsp;&nbsp;&nbsp;&nbsp;<span class="keyword">new</span><span>&nbsp;TextField(dd,&nbsp;field=&gt;field.SetPlaceHolder(</span><span class="string">"Your&nbsp;Name"</span><span>));&nbsp;&nbsp;</span></span></li><li class=""><span>&nbsp;&nbsp;&nbsp;&nbsp;<span class="keyword">new</span><span>&nbsp;CheckboxField(dd,&nbsp;</span><span class="string">"I&nbsp;like&nbsp;cayita"</span><span>,&nbsp;cb=&gt;&nbsp;{&nbsp;cb.Checked=</span><span class="keyword">true</span><span>;&nbsp;cb.Disabled=</span><span class="keyword">true</span><span>;&nbsp;}&nbsp;);&nbsp;&nbsp;</span></span></li><li class="alt"><span>&nbsp;&nbsp;&nbsp;&nbsp;<span class="keyword">new</span><span>&nbsp;TextArea(dd,&nbsp;area=&gt;&nbsp;&nbsp;area.Value=</span><span class="string">"cayita&nbsp;is&nbsp;amazing&nbsp;..."</span><span>);&nbsp;&nbsp;</span></span></li><li class=""><span>});&nbsp;&nbsp;</span></li><li class="alt"><span>&nbsp;&nbsp;</span></li><li class=""><span>Bootbox.Dialog(d,&nbsp;opt=&gt;{&nbsp;&nbsp;</span></li><li class="alt"><span>&nbsp;&nbsp;&nbsp;&nbsp;opt.Header=<span class="string">"large-modal"</span><span>;&nbsp;&nbsp;</span></span></li><li class=""><span>&nbsp;&nbsp;&nbsp;&nbsp;opt.Classes=<span class="string">"modal-large"</span><span>;&nbsp;&nbsp;</span></span></li><li class="alt"><span>&nbsp;&nbsp;&nbsp;&nbsp;opt.OnEscape=&nbsp;()=&gt;&nbsp;<span class="string">"ESC&nbsp;pressed"</span><span>.LogInfo();&nbsp;&nbsp;</span></span></li><li class=""><span>},&nbsp;&nbsp;</span></li><li class="alt"><span>bt=&gt;{&nbsp;&nbsp;</span></li><li class=""><span>&nbsp;&nbsp;&nbsp;&nbsp;bt.Add(<span class="keyword">new</span><span>&nbsp;DialogButton{&nbsp;&nbsp;</span></span></li><li class="alt"><span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Label=<span class="string">"Cancel"</span><span>,&nbsp;&nbsp;</span></span></li><li class=""><span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Callback=()=&gt;&nbsp;<span class="string">"Cancel&nbsp;pressed.&nbsp;Click&nbsp;here&nbsp;to&nbsp;delete&nbsp;message"</span><span>.LogError()&nbsp;&nbsp;</span></span></li><li class="alt"><span>&nbsp;&nbsp;&nbsp;&nbsp;});&nbsp;&nbsp;</span></li><li class=""><span>&nbsp;&nbsp;&nbsp;&nbsp;bt.Add(&nbsp;<span class="keyword">new</span><span>&nbsp;DialogButton{&nbsp;&nbsp;</span></span></li><li class="alt"><span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Label=<span class="string">"Save"</span><span>,&nbsp;&nbsp;</span></span></li><li class=""><span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Callback=&nbsp;()=&gt;&nbsp;<span class="string">"Save&nbsp;pressed"</span><span>.LogSuccess()&nbsp;&nbsp;</span></span></li><li class="alt"><span>&nbsp;&nbsp;&nbsp;&nbsp;});&nbsp;&nbsp;</span></li><li class=""><span>});&nbsp;&nbsp;</span></li></ol><textarea style="display:none;" class="originalCode">var d = new Div(null, dd=&gt;{\n\tdd.ClassName="span3";\n\tnew TextField(dd, field=&gt;field.SetPlaceHolder("Your Name"));\n\tnew CheckboxField(dd, "I like cayita", cb=&gt; { cb.Checked=true; cb.Disabled=true; } );\n\tnew TextArea(dd, area=&gt;\tarea.Value="cayita is amazing ...");\n});\n\nBootbox.Dialog(d, opt=&gt;{\n\topt.Header="large-modal";\n\topt.Classes="modal-large";\n\topt.OnEscape= ()=&gt; "ESC pressed".LogInfo();\n},\nbt=&gt;{\n\tbt.Add(new DialogButton{\n\t\tLabel="Cancel",\n\t\tCallback=()=&gt; "Cancel pressed. Click here to delete message".LogError()\n\t});\n\tbt.Add( new DialogButton{\n\t\tLabel="Save",\n\t\tCallback= ()=&gt; "Save pressed".LogSuccess()\n\t});\n});</textarea></div>');
		})).appendTo$1(parent);
