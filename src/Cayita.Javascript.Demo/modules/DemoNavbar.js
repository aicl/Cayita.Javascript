	...
	$DemoNavbar.execute = function(parent) {
		(new Cayita.UI.Div.$ctor2(null, function(div) {
			...
			new Cayita.UI.TopNavBar(div, 'App Title', function(nav) {
				...
				Extensions.addItem$3(nav, 'Config', new Cayita.UI.Menu(function(l) {
					Extensions.addItem$2(l, 'Users');
					Extensions.addItem$2(l, 'Groups');
					Extensions.addItem(l, new Cayita.UI.SubMenu('More Options', function(sm) {
