(function() {
	...
	$DemoForm.execute = function(parent) {
		$(parent).append(Cayita.UI.StringExtensions.header('Default styles', 2));
		...
		//------------------
		$(parent).append(Cayita.UI.StringExtensions.header('Optional Layouts', 2));
		$(parent).append(Cayita.UI.StringExtensions.header('Search form', 3));
		...
		//---------------------------------
		$(parent).append(Cayita.UI.StringExtensions.header('Inline Form', 3));
		...
		//--------------------------------
		$(parent).append(Cayita.UI.StringExtensions.header('Horizontal Form', 3));
		...
		//----------------------------------
		$(parent).append(Cayita.UI.StringExtensions.header('Samples', 2));
		$(parent).append(Cayita.UI.StringExtensions.header('Login Form', 3));
		...
		//-----------------------------------
		$(parent).append(Cayita.UI.StringExtensions.header('Contact Form', 3));
